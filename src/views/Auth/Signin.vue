...
onMounted(() => {
  if (route.query.locked === '1') {
    errorMsg.value = 'TÃ i khoáº£n cá»§a báº¡n Ä‘Ã£ bá»‹ khÃ³a. Vui lÃ²ng liÃªn há»‡ quáº£n trá»‹ viÃªn.'
  }
})
...
const handleSubmit = async () => {
  ...
  try {
    ...
    errorMsg.value = e.message || 'ÄÄƒng nháº­p tháº¥t báº¡i'
  } finally {
