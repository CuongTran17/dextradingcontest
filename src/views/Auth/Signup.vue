          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Nháº­p email vÃ  máº­t kháº©u Ä‘á»ƒ táº¡o tÃ i khoáº£n!
              </p>
            </div>
            <div>
                ...
                <div class="space-y-5">
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      >
                        TÃªn<span class="text-error-500">*</span>
                      </label>
                      <input
                        v-model="firstName"
                        type="text"
                    ...
                    <div class="sm:col-span-1">
                      <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                      >
                        Há»<span class="text-error-500">*</span>
                      </label>
                      <input
                        v-model="lastName"
                        type="text"
                  ...
                  <div>
                    <label
                      ...
                      class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                      Máº­t kháº©u<span class="text-error-500">*</span>
                    </label>
                    <div class="relative">
                      <input
                        v-model="password"
                    ...
                    <div>
                      ...
                      >
                        ...
                        <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                          Khi táº¡o tÃ i khoáº£n, báº¡n Ä‘á»“ng Ã½ vá»›i
                          <span class="text-gray-800 dark:text-white/90">
                            Äiá»u khoáº£n vÃ  Äiá»u kiá»‡n,
                          </span>
                          va
                          <span class="text-gray-800 dark:text-white"> ChÃ­nh sÃ¡ch báº£o máº­t </span>
                        </p>
                      </label>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      {{ isSubmitting ? 'Äang Ä‘Äƒng kÃ½...' : 'ÄÄƒng kÃ½' }}
                    </button>
                  </div>
                </div>
              </form>
...
const handleSubmit = async () => {
  if (!firstName.value || !lastName.value) {
    errorMsg.value = 'Vui lÃ²ng nháº­p há» tÃªn'
    return
  }
  if (!email.value || !password.value) {
    errorMsg.value = 'Vui lÃ²ng nháº­p email vÃ  máº­t kháº©u'
    return
  }
  if (password.value.length < 6) {
    errorMsg.value = 'Máº­t kháº©u pháº£i cÃ³ Ã­t nháº¥t 6 kÃ½ tá»±'
    return
  }
  if (!agreeToTerms.value) {
    errorMsg.value = 'Vui lÃ²ng Ä‘á»“ng Ã½ vá»›i Ä‘iá»u khoáº£n'
    return
  }
  ...
  try {
    ...
    errorMsg.value = e.message || 'ÄÄƒng kÃ½ tháº¥t báº¡i'
  } finally {
